        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center gap-8">
            ...
            {['Community', 'Markets', 'Brokers', 'More'].map((item) => (
              <Link key={item} href={`/${item.toLowerCase()}`} className={`text-gray-300 hover:text-white transition-all duration-300 hover:scale-105 relative group ${item.toLowerCase() === 'community' ? 'text-white' : ''}`}>
                {item}
            ...
            <Sheet>
                ...
                <SheetContent side="right" className="bg-slate-900/80 backdrop-blur-md border-cyan-400/20 text-white">
                  ...
                  <nav className="flex flex-col items-center gap-6 mt-12">
                      ...
                      <Link href="/community" className="text-xl text-white">Community</Link>
